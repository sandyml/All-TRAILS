puts "Clearing User/Location/Hike's old data..." 
User.destroy_all 
...
puts "📍 Location..." 
kaaterskill_falls = Location.create(
...
buttermilk_falls = Location.create(
...
sleeping_giant = Location.create(
...
breakneck_ridge = Location.create(
...
HikeTrail.create([
 ...
 {
  user_id: sandra.id,
  location_id: kaaterskill_falls.id,
